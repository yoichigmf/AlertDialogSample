...
class AlertDialogSample:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'AlertDialogSample_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&AlertDialogSample')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('AlertDialogSample', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/AlertDialogSample/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'disalog sample'),
            callback=self.run,
